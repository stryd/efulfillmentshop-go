...
// AddressWriteLd Address entity
type AddressWriteLd struct {
...
func (o AddressWriteLd) MarshalJSON() ([]byte, error) {
...
type NullableAddressWriteLd struct {
	value *AddressWriteLd
	isSet bool
}

func (v NullableAddressWriteLd) Get() *AddressWriteLd {
	return v.value
}

func (v *NullableAddressWriteLd) Set(val *AddressWriteLd) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressWriteLd) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressWriteLd) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressWriteLd(val *AddressWriteLd) *NullableAddressWriteLd {
	return &NullableAddressWriteLd{value: val, isSet: true}
}

func (v NullableAddressWriteLd) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressWriteLd) UnmarshalJSON(src []byte) error {
	v.isSet = true
